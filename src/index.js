...
const frm = document.querySelector("#cifrar")
...
frm.addEventListener("submit", (e) => {
    const mensagem = frm.inMsg.value.toUpperCase() // variável que está sendo atribuida a mensagem inserida pelo usuário no HTML
